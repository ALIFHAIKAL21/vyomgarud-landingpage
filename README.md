...
```bash
git clone https://github.com/ALIFHAIKAL21/vyomgarud-landingpage.git
cd vyomgarud-landingpage
```
...
4. Your app will be available at: [https://vyomgarud-jet.vercel.app/](https://vyomgarud-jet.vercel.app/)

More info: [Next.js Deployment Documentation](https://nextjs.org/docs/app/building-your-application/deploying)

## GitHub

* Repository: [https://github.com/ALIFHAIKAL21/vyomgarud-landingpage](https://github.com/ALIFHAIKAL21/vyomgarud-landingpage.git)

## Live Demo

* [https://vyomgarud-jet.vercel.app/](https://vyomgarud-jet.vercel.app/)
